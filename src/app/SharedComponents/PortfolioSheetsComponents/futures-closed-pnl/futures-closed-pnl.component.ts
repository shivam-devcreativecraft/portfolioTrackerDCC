...
@Component({
  selector: 'app-futures-closed-pnl',
  templateUrl: './futures-closed-pnl.component.html',
  styleUrls: ['./futures-closed-pnl.component.scss']
})
export class FuturesClosedPnlComponent implements OnInit {
  // private exchangeName:string='Bybit'; //for 1. MatTablle , 2. deleteEntry()
  // private sheetName:string='Futures_Closed_Pnl' //for 1. MatTablle , 2. deleteEntry()
  @Input() exchangeName: string = '';
  @Input() sheetName: string = 'Futures_Closed_Pnl';
  ...
  ngOnInit() {
    ...
    // console.log('Mexc on init : ', this.sheetName)
    let account;
