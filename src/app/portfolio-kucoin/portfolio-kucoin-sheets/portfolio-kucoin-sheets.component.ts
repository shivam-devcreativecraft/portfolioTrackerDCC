...
@Component({
  selector: 'app-portfolio-kucoin-sheets',
  templateUrl: './portfolio-kucoin-sheets.component.html',
  styleUrls: ['./portfolio-kucoin-sheets.component.scss']
})
export class PortfolioKucoinSheetsComponent implements OnInit{
        ...
        dialogRef.afterClosed().subscribe((result) => {
          if (result) {
            ...
            const dialogRef = this._dialog.open(AddNewComponent, {
              data : {ExchangeName : 'Kucoin', SheetName : 'Spot_Trades'},
