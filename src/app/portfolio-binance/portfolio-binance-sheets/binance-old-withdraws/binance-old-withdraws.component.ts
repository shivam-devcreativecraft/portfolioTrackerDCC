...
@Component({
  selector: 'app-binance-old-withdraws',
  templateUrl: './binance-old-withdraws.component.html',
  styleUrls: ['./binance-old-withdraws.component.scss'],
})
export class BinanceOldWithdrawsComponent implements OnDestroy {
  private exchangeName:string='Binance'; //for 1. MatTablle , 2. deleteEntry()
  private sheetName:string='Old_Withdraws' //for 1. MatTablle , 2. deleteEntry()
  ...
  constructor(
    ...
    this.displayedColumns=this.functionsServiceRef.binance_DisplayColumns.Old_Withdraws
