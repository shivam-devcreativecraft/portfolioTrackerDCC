...
@Component({
  ...
  styleUrls: ['./withdraw-crypto.component.scss'],
})
export class BinanceWithdrawCryptoComponent implements OnDestroy {
  private exchangeName:string='Binance'; //for 1. MatTablle , 2. deleteEntry()
  private sheetName:string='Money_Flow_Crypto' //for 1. MatTablle , 2. deleteEntry()
  ...
  constructor(
    ...
    this.displayedColumns = this.functionsServiceRef.binance_DisplayColumns.Money_Flow_Crypto
