...
@Component({
  selector: 'app-future-pnl',
  templateUrl: './binance-futures-pnl.component.html',
  styleUrls: ['./binance-futures-pnl.component.scss'],
})
export class BinanceFuturesPNLComponent implements OnDestroy {
 
  private exchangeName:string='Binance'; //for 1. MatTablle , 2. deleteEntry()
  private sheetName:string='Futures_PNL' //for 1. MatTablle , 2. deleteEntry()
  ...
  constructor(
    ...
    this.displayedColumns =this.functionsServiceRef.binance_DisplayColumns.Futures_Pnl;
