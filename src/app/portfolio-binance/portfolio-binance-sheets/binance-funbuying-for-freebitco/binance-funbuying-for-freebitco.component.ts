...
@Component({
  selector: 'app-funbuying-for-freebitco',
  templateUrl: './binance-funbuying-for-freebitco.component.html',
  styleUrls: ['./binance-funbuying-for-freebitco.component.scss']
})
export class BinanceFunbuyingForFreebitcoComponent implements OnDestroy {
private exchangeName:string='Binance'; //for 1. MatTablle , 2. deleteEntry()
private sheetName:string='FunBuySell_For_FreeBitco' //for 1. MatTablle , 2. deleteEntry()
...
IsMasterControlEnabled: boolean = false;
  ...
  constructor(
    ...
    this.displayedColumns=this.functionsServiceRef.binance_DisplayColumns.Fun_Buying_Depoit;
