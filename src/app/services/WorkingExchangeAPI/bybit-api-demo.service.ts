...
export class BybitAPIDemoService {
  private apiKey = environment.BYBIT_API_KEY_DEMO;
  private secret = environment.BYBIT_API_SECRETE_DEMO;
  private recvWindow = 5000000;
  private timestamp = Date.now().toString();
  private url = 'https://api-demo.bybit.com'; // You can switch to the mainnet URL when ready
